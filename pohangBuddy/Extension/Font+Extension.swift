...
extension Font {
    static let display1: Font = .custom("Pretendard-SemiBold", size: 24)
    ...
    static let head3: Font = .custom("Pretendard-Medium", size: 16)     // 카드 소제목, 네비게이션 타이틀
    static let head4: Font = .custom("Pretendard-SemiBold", size: 15)
